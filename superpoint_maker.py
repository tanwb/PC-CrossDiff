...
if __name__ == '__main__':
    data_path = r"/data2/zyc/data/EDA_lrh/EDA-master/data_root"  # ScanRefer path
    data_path_scannet = r"/data2/zyc/data/EDA_lrh/EDA-master/data_root/scannetv2"  # ScanNetv2 path
    split = 'val'
